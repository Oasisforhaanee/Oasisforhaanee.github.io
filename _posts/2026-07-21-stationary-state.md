...
tags: [stationary-state, schrödinger-equation, quantum-mechanics]
published: true
description: 정상 상태 개념과 시간 독립 슈뢰딩거 방정식이 성립하는 조건, 중첩 상태에서 에너지가 어떻게 달라지는지 설명합니다.
---
...
이는 일정한 파수, 즉 일정한 파장을 가지는 파동함수만이 특정 에너지를 가진다는 뜻입니다. 그것들이 중첩된 파동함수는, 중첩된 정도에 따라 에너지가 달라지게 됩니다. 이 내용은 추후 계속 다룰 것이니 여기까지만 하겠습니다.
...
---
> 이 글은 저의 주관대로 쓴 것이니 잘못된 정보가 있을 수 있습니다. 질문은 언제든지 환영이니 편하게 질문해주세요.
